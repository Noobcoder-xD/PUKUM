...
USERNAME = environ.get('USERNAME', "https://telegram.me/PYROMOVIES")
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002173701795'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002173701795'))
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002173701795'))
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002322249301')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002173701795'))
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002322249301'))
